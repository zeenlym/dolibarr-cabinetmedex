...
/**
 * 	\defgroup   mymodule     Module CabinetMedEx
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/mymodule/core/modules directory.
 *  \file       htdocs/mymodule/core/modules/modCabinetMedEx.class.php
 *  \ingroup    mymodule
 *  \brief      Description and activation file for module CabinetMedEx
 */
include_once DOL_DOCUMENT_ROOT .'/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module CabinetMedEx
 */
class modCabinetMedEx extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->numero = 31000000;		// TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'cabinetmedex';
		...
		$this->depends = array('modCabinetMed');		// List of modules id that must be enabled if this module is enabled
		$this->requiredby = array();	// List of modules id to disable if this one is disabled
		$this->conflictwith = array();	// List of modules id this module is in conflict with
		$this->phpmin = array(5,0);					// Minimum version of PHP required by module
		$this->need_dolibarr_version = array(3,0);	// Minimum version of Dolibarr required by module
		$this->langfiles = array("cabinetmedex@cabinetmedex");
        ...
        */
		...
		// $this->export_label[$r]='CabinetMedEx';	// Translation key (used only if key ExportDataset_xxx_z not found)
        // $this->export_enabled[$r]='1';                               // Condition to show export in list (ie: '$user->id==3'). Set to 1 to always show when module is enabled.
        // $this->export_icon[$r]='generic:CabinetMedEx';					// Put here code of icon then string for translation key of module name
	...
	public function init($options='')
	{
		...
		$this->_load_tables('/cabinetmedex/sql/');
	...
	private function _initTabs()
	{
		...
		$this->tabs = array(
				'thirdparty:+logbook:SUBSTITUTION_LogBook:logbook@cabinetmedex:$user->rights->cabinetmedex->logbook->read && ($object->canvas=="patient@cabinetmed" || $soc->canvas=="patient@cabinetmed"):/cabinetmedex/logbook.php?socid=__ID__'
		);
	}

	private function _initRights()
	{
		// Permissions
		...
		$this->rights[$r][1] = 'Read patient logbook';	// Permission label
		$this->rights[$r][3] = 0; 						// Permission by default for new user (0/1)
		$this->rights[$r][4] = 'logbook';					// In php code, permission will be checked by test if ($user->rights->permkey->level1->level2)
		$this->rights[$r][5] = 'read';						// In php code, permission will be checked by test if ($user->rights->permkey->level1->level2)
		$r++;
		
		$this->rights[$r][0] = $this->numero + $r;
		$this->rights[$r][1] = 'Add line to logbook';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'logbook';
		$this->rights[$r][5] = 'add';
		$r++;
		
		$this->rights[$r][0] = $this->numero + $r;
		$this->rights[$r][1] = 'Edit own lines in logbook';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'logbook';
		$this->rights[$r][5] = 'edit_own';
		$r++;
		
		$this->rights[$r][0] = $this->numero + $r;
		$this->rights[$r][1] = 'Edit others lines in logbook';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'logbook';
		$this->rights[$r][5] = 'edit_all';
		$r++;
		
		$this->rights[$r][0] = $this->numero + $r;
		$this->rights[$r][1] = 'Delete own lines in logbook';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'logbook';
		$this->rights[$r][5] = 'delete_own';
		$r++;
		
		$this->rights[$r][0] = $this->numero + $r;
		$this->rights[$r][1] = 'Delete others lines in logbook';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'logbook';
		$this->rights[$r][5] = 'delete_all';
		$r++;
	}
}
